...
public class WeatherActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void queryWeatherCode(String countryCode) {
        ...
        queryFromServer(countryCode, "countryCode");
    }
    ...
    private void queryFromServer(final String address, final String type) {
        if ("weatherCode".equals(type)) {
            ApiManager.getInstance().getTestApi().getWeather(address).enqueue(new Callback<CommonObjectResponse<Weather>>() {
                @Override
            ...
            ApiManager.getInstance().getTestApi().getWeatherCode(address).enqueue(new Callback<String>() {
                @Override
